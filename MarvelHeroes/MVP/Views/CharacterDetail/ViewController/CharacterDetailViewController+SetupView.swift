...
extension CharacterDetailViewController {
    ...
    func setupTableView() {
        ...
        infoTable.register(ImageInfoTableViewCell.self, forCellReuseIdentifier: "ImageInfoTableCell")        
        infoTable.delegate = self
        infoTable.dataSource = self
        infoTable.backgroundColor = UIColor(red: 1, green: 1, blue: 1, alpha: 0.9)
